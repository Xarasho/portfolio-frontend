  ...
  return (
    <aside className="flex flex-col w-1/4 px-10 py-10 bg-neutral-900 my-14 rounded-2xl border border-neutral-800 justify-between">
      ...
      <div className="flex flex-col items-center gap-5">
        <Info type="email" content="xarasho.mail@gmail.com" />
        <Info type="phone" content="+52 477 865 1898" />
        <Info type="birthday" content="September 14, 1995" />
        <Info type="location" content="Salamanca, Guanajuato" />
      </div>
